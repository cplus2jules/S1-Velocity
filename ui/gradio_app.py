...
### ✨ Special Markers
Markers with corresponding onomatopoeia:
...
def create_ui():
    ...
    with gr.Blocks(
        ...
        with gr.Tabs():
            ...
            # Marker Guide Tab
            with gr.Tab("🎭 Marker Guide"):
                gr.Markdown(format_marker_guide())
